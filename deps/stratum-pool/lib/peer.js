...
var commandStringBuffer = function(s) {return fixedLenStringBuffer(s, 12);};
...
var Peer = module.exports = function (options) {
	...
	var invCodes = { // https://en.bitcoin.it/wiki/Protocol_specification#Inventory_Vectors
		error: 0,
		tx: 1,
		block: 2
	};
	...
	var userAgent = util.varStringBuffer('/NOMP-RIC/');
